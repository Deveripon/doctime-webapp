        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!-- Profile Sidebar -->
                    @include('patients.profilesidebar')
                    <!-- /Profile Sidebar -->
                                    ...
                                    <div class="row form-row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="first_name" type="text" class="form-control" value="Richard">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label>Last Name</label>
                                                <input name="last_name" type="text" class="form-control" value="Wilson">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="cal-">
                                                    <input name="date-of-birth" type="date" class="form-control datetimepicker" value="24-07-1983">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
